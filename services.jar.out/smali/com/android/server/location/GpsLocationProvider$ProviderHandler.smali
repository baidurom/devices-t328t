...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1}, Lcom/android/server/location/GpsLocationProvider;->access$1900(Lcom/android/server/location/GpsLocationProvider;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v1, v2}, Lcom/android/server/location/GpsLocationProvider;->access$2072(Lcom/android/server/location/GpsLocationProvider;I)I
    ...
    invoke-static {v1}, Lcom/android/server/location/GpsLocationProvider;->access$2110(Lcom/android/server/location/GpsLocationProvider;)I
    ...
    invoke-static {v1}, Lcom/android/server/location/GpsLocationProvider;->access$2000(Lcom/android/server/location/GpsLocationProvider;)I
    ...
    invoke-static {v1}, Lcom/android/server/location/GpsLocationProvider;->access$800(Lcom/android/server/location/GpsLocationProvider;)V
    ...
    invoke-static {v3, v1}, Lcom/android/server/location/GpsLocationProvider;->access$1000(Lcom/android/server/location/GpsLocationProvider;Z)V
    ...
    invoke-static {v3, v4, v1}, Lcom/android/server/location/GpsLocationProvider;->access$1200(Lcom/android/server/location/GpsLocationProvider;ILandroid/net/NetworkInfo;)V
    ...
    invoke-static {v4}, Lcom/android/server/location/GpsLocationProvider;->access$1400(Lcom/android/server/location/GpsLocationProvider;)Z
    ...
    #getter for: Lcom/android/server/location/GpsLocationProvider;->mSupportsXtra:Z
    invoke-static {v1}, Lcom/android/server/location/GpsLocationProvider;->access$1400(Lcom/android/server/location/GpsLocationProvider;)Z
    ...
    invoke-static {v3, v1}, Lcom/android/server/location/GpsLocationProvider;->access$1600(Lcom/android/server/location/GpsLocationProvider;Landroid/location/Location;)V
