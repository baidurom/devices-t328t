...
.method public performHapticFeedback(Landroid/view/IWindow;IZ)Z
    ...
    invoke-virtual {v5, p0, p1, v6}, Lcom/android/server/wm/WindowManagerService;->windowForClientLocked(Lcom/android/server/wm/Session;Landroid/view/IWindow;Z)Lcom/android/server/wm/WindowState;

    move-result-object v5

    invoke-interface {v3, v5, p2, p3}, Landroid/view/WindowManagerPolicy;->performHapticFeedbackLw(Landroid/view/WindowManagerPolicy$WindowState;IZ)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    const-string v6, "performHapticFeedback, ex: "
...
.method public sendActionUpPositionForAnimation(FFLandroid/view/IWindow;)V
    ...
    invoke-virtual {v0, p0, p3, p1, p2}, Lcom/android/server/wm/WindowManagerService;->sendActionUpPositionForAnimationWithWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;FF)V
...
.method public updatePenWorkingMode(Landroid/view/IWindow;I)V
    ...
    invoke-virtual {v0, p0, p1, p2}, Lcom/android/server/wm/WindowManagerService;->setPenWorkingMode(Lcom/android/server/wm/Session;Landroid/view/IWindow;I)V
...
.method public updateTransitionParameter(Landroid/view/IWindow;Landroid/graphics/Rect;Landroid/graphics/Rect;FFZ)V
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/wm/WindowManagerService;->updateTransitionParameterWithWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;Z)V
