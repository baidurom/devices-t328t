...
.method private setEnabledFunctions(Ljava/lang/String;Z)V
    ...
    iput-object v9, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mCurrentKernelFunctions:Ljava/lang/String;
    ...
    iget-object v10, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mCurrentKernelFunctions:Ljava/lang/String;

    const-string v11, "diag"

    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v10, v11}, Lcom/android/server/usb/UsbDeviceManager;->access$600(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v10

    #setter for: Lcom/android/server/usb/UsbDeviceManager;->mDiagEnabled:Z
    invoke-static {v9, v10}, Lcom/android/server/usb/UsbDeviceManager;->access$1002(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    invoke-static {v9, v10}, Lcom/android/server/usb/UsbDeviceManager;->access$1102(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    :try_end_0
    ...
    invoke-static {p1, v9}, Lcom/android/server/usb/UsbDeviceManager;->access$1200(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {p1, v9}, Lcom/android/server/usb/UsbDeviceManager;->access$600(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v10, "Error FileReader reader2"
    ...
    const-string v10, "Error Exception"
    ...
    invoke-static {p1, v9}, Lcom/android/server/usb/UsbDeviceManager;->access$1300(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v11, "set persist.sys.usb.config to: "
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v9, v10}, Lcom/android/server/usb/UsbDeviceManager;->access$600(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v9, "/sys/devices/system/cpu/cpu1/online"

    invoke-direct {v5, v9}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 542
    .local v5, sAttrFile:Ljava/io/File;
    ...
    const-string v11, "[USBNET] mbModifyCpu1="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-boolean v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mbModifyCpu1:Z

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v10

    const-string v11, ",mbModifyMpDec="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-boolean v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mbModifyMpDec:Z
    ...
    .line 545
    iget-boolean v9, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mbModifyCpu1:Z
    ...
    :try_start_3
    invoke-static {v5, v9, v10}, Landroid/os/FileUtils;->readTextFile(Ljava/io/File;ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 549
    .local v7, szCurrentCpu1:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$100()Ljava/lang/String;
    ...
    const-string v11, "[USBNET] szCurrentCpu1="
    ...
    invoke-static {v9, v10}, Landroid/os/FileUtils;->stringToFile(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_2

    .line 555
    .end local v7           #szCurrentCpu1:Ljava/lang/String;
    :cond_a
    :goto_3
    const/4 v9, 0x0

    iput-boolean v9, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mbModifyCpu1:Z

    .line 557
    :cond_b
    iget-boolean v9, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mbModifyMpDec:Z

    if-eqz v9, :cond_d

    .line 559
    const-string v9, "init.svc.mpdecision"
    ...
    .line 560
    .local v8, szMpDec:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$100()Ljava/lang/String;
    ...
    const-string v11, "[USBNET] mpdecision="
    ...
    .line 569
    .end local v5           #sAttrFile:Ljava/io/File;
    .end local v8           #szMpDec:Ljava/lang/String;
    :cond_d
    ...
    .line 597
    const-string v9, "net.usb0.isharing.host"
    ...
    .line 606
    .restart local v5       #sAttrFile:Ljava/io/File;
    const/4 v9, 0x0
    ...
    .line 611
    .restart local v8       #szMpDec:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$100()Ljava/lang/String;
    ...
    .line 619
    .restart local v7       #szCurrentCpu1:Ljava/lang/String;
    invoke-static {}, Lcom/android/server/usb/UsbDeviceManager;->access$100()Ljava/lang/String;
