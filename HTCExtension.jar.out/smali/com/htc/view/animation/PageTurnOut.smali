.class public Lcom/htc/view/animation/PageTurnOut;
.super Lcom/htc/view/animation/QuickTipsAnimation;
.source "PageTurnOut.java"
...
.method public constructor <init>(Lcom/htc/view/animation/QuickTipsAnimation$TipsCurlAnimationListener;)V
    ...
    .line 20
    iput-boolean v0, p0, Lcom/htc/view/animation/PageTurnOut;->isAnimationEnding:Z

    .line 21
    iput-boolean v0, p0, Lcom/htc/view/animation/PageTurnOut;->stoped:Z
...
.method public onDraw(Landroid/opengl/GLSurfaceView;Ljavax/microedition/khronos/opengles/GL10;)V
    ...
    .line 94
    iget v0, p0, Lcom/htc/view/animation/PageTurnOut;->x:I

    iget v1, p0, Lcom/htc/view/animation/PageTurnOut;->endx:I
    ...
    iget v1, p0, Lcom/htc/view/animation/PageTurnOut;->y:I
    ...
    iget v1, p0, Lcom/htc/view/animation/PageTurnOut;->dx:I

    add-int/2addr v0, v1

    iput v0, p0, Lcom/htc/view/animation/PageTurnOut;->x:I

    .line 102
    iget v0, p0, Lcom/htc/view/animation/PageTurnOut;->y:I

    iget v1, p0, Lcom/htc/view/animation/PageTurnOut;->dy:I

    add-int/2addr v0, v1

    iput v0, p0, Lcom/htc/view/animation/PageTurnOut;->y:I
    ...
    .line 103
    :cond_1
    iget-boolean v0, p0, Lcom/htc/view/animation/PageTurnOut;->isAnimationEnding:Z
    ...
    .line 110
    iput-boolean v3, p0, Lcom/htc/view/animation/PageTurnOut;->isAnimationEnding:Z

    goto :goto_0

    .line 111
    :cond_3
    iget-boolean v0, p0, Lcom/htc/view/animation/PageTurnOut;->stoped:Z
...
.method public onStart()V
    ...
    iput v0, p0, Lcom/htc/view/animation/PageTurnOut;->startx:I
    ...
    iput v0, p0, Lcom/htc/view/animation/PageTurnOut;->starty:I

    .line 72
    iput v3, p0, Lcom/htc/view/animation/PageTurnOut;->endx:I
    ...
    iput v0, p0, Lcom/htc/view/animation/PageTurnOut;->endy:I

    .line 75
    iget v0, p0, Lcom/htc/view/animation/PageTurnOut;->endx:I

    iget v1, p0, Lcom/htc/view/animation/PageTurnOut;->startx:I

    sub-int/2addr v0, v1

    div-int/lit8 v0, v0, 0xa

    iput v0, p0, Lcom/htc/view/animation/PageTurnOut;->dx:I

    .line 76
    iget v0, p0, Lcom/htc/view/animation/PageTurnOut;->endy:I

    iget v1, p0, Lcom/htc/view/animation/PageTurnOut;->starty:I

    sub-int/2addr v0, v1

    div-int/lit8 v0, v0, 0xa

    iput v0, p0, Lcom/htc/view/animation/PageTurnOut;->dy:I

    .line 77
    iget v0, p0, Lcom/htc/view/animation/PageTurnOut;->startx:I

    iput v0, p0, Lcom/htc/view/animation/PageTurnOut;->x:I

    .line 78
    iget v0, p0, Lcom/htc/view/animation/PageTurnOut;->starty:I
    ...
    invoke-static {v0, v1, v2}, Lcom/htc/view/animation/QuickTipsAnimationLib;->curlBegin(IIZ)I
    ...
    .line 85
    iput-boolean v3, p0, Lcom/htc/view/animation/PageTurnOut;->stoped:Z
...
.method public setBGImage(Landroid/graphics/Bitmap;)V
    ...
    .line 47
    sget-object v0, Lcom/htc/view/animation/PageTurnOut;->animating:Lcom/htc/view/animation/QuickTipsAnimationView$Animation;
